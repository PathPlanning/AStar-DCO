...
bool FakeMap::getMap(const char *FileName)
{
    ...
    {
        std::cout<<"some additional checks\n";
        return false;
    }
...
bool FakeMap::CellIsObstacle(int i, int j) const
{
    return false;
}

int FakeMap::getValue(int i, int j) const
{
    return Map::getValue(i, j) >= 0 ? 0 : -1;
}
